...
namespace UnityEditor.Tilemaps
{
    ...
    /// </summary>
    [CustomGridBrush(false, true, false, "Non Stack Prefab Brush")]
    public class NonStackPrefabBrush : BasePrefabBrush
    {
        ...
        /// The NonStackPrefabBrush overrides this to provide Prefab painting functionality.
        /// </summary>
        ...
        public override void Paint(GridLayout grid, GameObject brushTarget, Vector3Int position)
        {
            ...
            WipeObjectsInCell(grid, brushTarget, position);
        ...
        /// <summary>
        /// Paints the NonStackPrefabBrush instance's prefab into all positions specified by the box fill tool.
        /// </summary>
        /// <param name="grid">Grid used for layout.</param>
        ...
        /// The NonStackPrefabBrush overrides this to provide Prefab erasing functionality.
        /// </summary>
        /// <param name="grid">Grid used for layout.</param>
        ...
        /// </summary>
        [CustomEditor(typeof(NonStackPrefabBrush))]
        public class NonStackPrefabBrushEditor : BasePrefabBrushEditor
        {
            private NonStackPrefabBrush prefabBrush => target as NonStackPrefabBrush;
            private SerializedProperty m_Prefab;

            /// <summary>
            /// OnEnable for the NonStackPrefabBrushEditor
            /// </summary>
        ...
        [MenuItem("Assets/Create/2D/Brushes/Non Stack Prefab Brush")]
        static void CreatePrefabBrush()
        {
            ProjectWindowUtil.CreateAsset(ScriptableObject.CreateInstance<NonStackPrefabBrush>(), "New Non Stack Prefab Brush.asset");
        }
    }
}
